...
local Italic = ""
if vim.g._italic then
  Italic = "italic"
end

local Bold = ""
if vim.g.roboduckfork_bold then
  Bold = "bold"
end
...
local scheme = {
  ...
  Cursor = {
    fg = colors.blackish.hex,
    ctermfg = colors.blackish.cterm,
    bg = colors.grey.hex,
    ctermbg = colors.grey.cterm,
  },
  CursorIM = { link = "Cursor" },
  CursorLine = { bg = colors.dark_blue.hex, ctermfg = colors.dark_blue.cterm },
  CursorLineNr = {
    fg = colors.greyer.hex,
    ctermfg = colors.greyer.cterm,
    bg = colors.dark_blue.hex,
    ctermbg = colors.dark_blue.cterm,
  },
  ...
  Folded = {
    ...
    ctermfg = colors.grey_purple.cterm,
    bg = colors.blackish.hex,
    ctermbg = colors.blackish.cterm,
  },
  FoldColumn = {
  ...
  PmenuSbar = { bg = colors.cream.hex, ctermbg = colors.cream.cterm },
  ...
  Search = {
    fg = colors.white.hex,
    ctermfg = colors.white.cterm,
    bg = colors.grey_purple.hex,
    ctermbg = colors.grey_purple.cterm,
  },
  SpecialKey = {
    fg = colors.orange.hex,
    ctermfg = colors.orange.cterm,
  ...
  WildMenu = {
    fg = colors.black.hex,
    ctermfg = colors.black.cterm,
    bg = colors.greyer.hex,
    ctermbg = colors.greyer.cterm,
  },
  ...
  Comment = { fg = colors.cream.hex, ctermfg = colors.cream.cterm },
